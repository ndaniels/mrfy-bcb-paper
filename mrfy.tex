...
\documentclass[blockstyle,times,preprint]{sigplanconf}
...
\and Lenore Cowen\thanks{Corresponding author: lenore.cowen@tufts.edu}}
...
\begin{center}
  \fbox{\includegraphics[width=2.8in]{50249-roc.pdf}}
   ...
   For this analysis, MRFy was run using the options corresponding to
    ``MRFy$^2$'' in Table~\ref{mrfy-auc}; namely, local search with a time
    limit of 30 seconds, and template-based initial guesses.
   }
   \label{roc-curves}
 \end{center}
\end{figure}
