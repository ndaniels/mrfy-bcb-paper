...
considered in \cite{Daniels:2012dg}, we show a mean XX\% (median YY\%) 
...
and output the best alignment seen thus far (three options).
...
Thanks to Richard Senington for the original local search implementation, and
